"""
Agent orchestration logic for chat interactions.

Handles agent framework invocation, thread/conversation caching, streaming response
generation, and telemetry. This module has no FastAPI route-binding imports at the
top level and is importable without starting the FastAPI application.
"""
